...
class PasswordConstraint extends AbstractConstraint {
    ...
    private static final String DEFAULT_MESSAGE_CODE = "default.password.invalid.message";
	...
	/**
	 *  reference 
	 * http://stackoverflow.com/questions/21463121/building-password-validation-regex-dynamically
	 */
    
	boolean validate(target, propertyValue) {
		propertyValue ==~ /?=.*[^a-zA-Z])(?=.*[a-z])(?=.*[A-Z]).{8,}/
    }
}
